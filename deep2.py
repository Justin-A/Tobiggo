...
class deep2():
    def __init__(self, game):
        ...
        h_conv3_flat = tf.reshape(h_conv3, [-1, 512 * (self.board_x) * (self.board_y)])
        s_fc1 = dropout(relu(batchnormalization(dense(h_conv3_flat, 1024), axis = 1, training = self.istraining)), rate = 1.0)
